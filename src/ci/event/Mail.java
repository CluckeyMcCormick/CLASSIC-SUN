...
/**
 *
 * edited example code for use by Tim Holcombe
 */
public class Mail {
    private static String username="sun.cievents@gmail.com";
    private static String password="comp350sun";
